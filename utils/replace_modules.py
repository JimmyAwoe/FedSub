...
def replace_with_subscaf_linear(model, target_modules_list, device, args):
    def replace_module(model, target_modules_list, device):
    ...
    lbd = []
    comp_mat_rec = {} 
    replace_module(model, target_modules_list, device)
