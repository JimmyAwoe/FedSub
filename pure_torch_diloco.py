...
def main(
    ...
    project: str = "diloco",
    config_path: str = "configs/llama_60m.json",
    lr: float = 4e-4,
    outer_lr: float = 0.7,
    local_steps: int = 500,
):
    ...
    #outer_optimizer = torch.optim.AdamW(
        #model.parameters(), lr=outer_lr, betas=(0.9, 0.95)
    #)
    ...
    ds = load_dataset('/data/datasets/c4/en', streaming=True)
